...
Page({
    ...
    douban.find(this.data.type, this.data.page++, this.data.size)
      .then(d => {
        if (d.subjects.length) {
          this.setData({subtitle: this.data.title, movies: this.data.movies.concat(d.subjects), loading: false })
        } else {
  ...
  onLoad(params){
    ...
    console.log("onLoad params is "+params.title+params.type)
    ...
    douban.find(this.data.type, this.data.page++, this.data.size)
      .then(d => {
        if (d.subjects.length) {
          this.setData({ subtitle: this.data.title, movies: d.subjects, loading: false })
        } else {
