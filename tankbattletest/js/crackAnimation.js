...
export default class CrackAnimation {
	constructor (type,context,crackObj) {
		...
		this.draw = function(){
			...
			this.ctx.drawImage(CONST.RESOURCE_IMAGE,CONST.POS[this.posName][0]+temp*this.size,CONST.POS[this.posName][1],this.size,this.size,this.x,this.y,this.size,this.size);
