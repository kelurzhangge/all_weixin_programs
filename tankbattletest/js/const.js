...
//POS["num"] = [256,96];
POS["num"] = [257,96];//因为stage后面的level值而调整
POS["map"] = [0,96];
POS["home"] = [256,0];
POS["score"] = [0,112];
POS["player"] = [0,0];
...
module.exports = {
	...
	TANK_DESTROY_AUDIO: TANK_DESTROY_AUDIO,
	PLAYER_DESTROY_AUDIO: PLAYER_DESTROY_AUDIO,
	MOVE_AUDIO: MOVE_AUDIO,
	ATTACK_AUDIO:ATTACK_AUDIO,
	PROP_AUDIO: PROP_AUDIO,
	...
	ICE: ICE,
	HOME: HOME,
	ANOTHREHOME: ANOTHREHOME,
	UP: UP,
	DOWN: DOWN,
	LEFT: LEFT,
	RIGHT: RIGHT,
	ENEMY_LOCATION:ENEMY_LOCATION,
	BULLET_TYPE_PLAYER: BULLET_TYPE_PLAYER,
	BULLET_TYPE_ENEMY: BULLET_TYPE_ENEMY,
	CRACK_TYPE_TANK: CRACK_TYPE_TANK,
	CRACK_TYPE_BULLET: CRACK_TYPE_BULLET
